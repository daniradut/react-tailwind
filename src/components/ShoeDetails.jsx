...
import { QTY, SIZES } from "../components/constants";
            ...
            <div className="flex-1 space-y-6">
                ...
                <div className="space-x-10">
                    <button
                        ...
                        className="text-white bg-black btn-press-anim h-14 w-44 hover:bg-gray-900 active:bg-gray-700 dark:bg-white dark:text-black"
                    >
                        Add to bag
                    </button>
                    <a
